...
class Modal extends React.Component {
    ...
    renderText = (modalType) => {
        if (modalType === 'graduate') {
            return <p>Are you sure you want to remove this device from the Sandbox? You will not be able undo this
                action or access this device in the Quick Start Experience.</p>
        }
